...
var Header = function () {
	function Header() {
		...
		this.navLinks = [].concat(_toConsumableArray(this.nav.children));
	...
	_createClass(Header, [{
		...
		value: function toggleMenu() {
			...
			switch (state) {
				case 'open':
					this.burger.classList.add(_helpers.css.active);
					break;
				case 'close':
		...
		value: function prepareBurgerAnim() {
			...
			this.burgerTl.to(this.burgerLines[0], 0.5, {
				rotation: 45,
				y: 6
			}, 0).to(this.burgerLines[1], 0.3, {
				alpha: 0,
				width: 0
			}, 0).to(this.burgerLines[2], 0.5, {
				rotation: -45,
				y: -6
			}, 0);
		}
		...
		key: 'prepareNavAnim',
		value: function prepareNavAnim() {
			this.navTl = new _gsap.TimelineMax({ paused: true });

			this.navTl.set(this.navLinks, {
				autoAlpha: 0,
				y: -20
			}).to(this.nav, 0.5, {
				autoAlpha: 1
			}, 0).staggerTo(this.navLinks, 0.5, {
				autoAlpha: 1,
				y: 0
			}, 0.125);
		}
		...
		get: function get() {
			return this.burger.classList.contains(_helpers.css.active);
		}
	}]);
